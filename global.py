...
fxx_list = [108,114, 120,126,132,138,144,150,156,162, 168,174,180, 192,204, 216,228, 240]
...
for fxx in fxx_list:
    try:
        ...
        filename = f"{fxx}.png"
        save_full_path = os.path.join(save_path_9, filename)
        plt.savefig(save_full_path, dpi=150, bbox_inches='tight')
        plt.close(fig)  
        print("所有圖片已全部生成！")
        ...
        filename = f"{fxx}.png"
        save_full_path = os.path.join(save_path_10, filename)
        plt.savefig(save_full_path, dpi=150, bbox_inches='tight')
        plt.close(fig)  
        ...
        filename = f"{fxx}.png"
        save_full_path = os.path.join(save_path_11, filename)
        plt.savefig(save_full_path, dpi=150, bbox_inches='tight')
        plt.close(fig)  
        ...
        save_full_path = os.path.join(save_path_12, f"{fxx}.png")
        plt.savefig(save_full_path, dpi=150, bbox_inches='tight')
        plt.close()
